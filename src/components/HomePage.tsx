    ...
    <Wrapper>
      ...
      <AboutSection id="about">
        ...
        <p className="about-text">
          A software engineer with expertise in full-stack development, cloud
          computing, and machine learning. Pursuing my Master's in Computer
          Science at Northeastern University, I bring over two years of
          experience in software engineering and cloud technologies. I'm
          passionate about creating impactful solutions and contributing to
          diversity in STEM through the Society of Women Engineers.
        </p>
